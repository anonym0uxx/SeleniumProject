...
public class SuiteListenerTest implements ITestListener, ISuiteListener {
    ...
    public void onFinish(ITestContext context) {
        ...
        ExtentReportManagerTest.flushReport();  // Flushes the extent report
        ExtentReportManagerTest.sendReportByEmail();  // Sends the report via email
    ...
    public void onFinish(ISuite suite) {
        ...
        try {
            TwilioUtilTest.sendTestResults(messageContent);

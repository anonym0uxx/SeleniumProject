...
public class ContactUsTest {
    ...
    public void setUp(@Optional("chrome") String browser, ITestContext context) {
        ...
        System.out.println("THIS IS THE SUITE NAME: "+TestConstantsTest.SUITE_NAME);
        //Now we check the screenshot DIR
        String screenshotDir = TestConstantsTest.SCREENSHOT_DIR + File.separator + TestConstantsTest.SUITE_NAME + File.separator + TestConstantsTest.TIMESTAMP;
        System.out.println("This is the screenshot DIR: "+screenshotDir);
        ...
        System.out.println("This is the Suite name: ");
    ...
    public void testContactUs() {
        try {
            ...
            test.pass("Navigated to " +TestConstantsTest.G1_HOME_URL);
    ...
    private void fillAppointmentForm() {
        try {
            ...
            DriverUtilsTest.takeScreenshot(driver, "Appointment_Form_Filled");

...
public class GoldenOneHomePageTest {
    ...
    public void setUp(ITestContext context) {
        ...
        extentReport = ExtentReportManagerTest.getInstance(TestConstantsTest.SUITE_NAME);
        Golden1SmokeTest = extentReport.createTest("Golden1.com Smoke Test", "Validates basic member-facing website functionality");

        // Setup WebDriver
        driver = DriverUtilsTest.getDriver("chrome");
    ...
    public void testGolden1HomePage() {
        ...
        Golden1SmokeTest.pass("Navigated to " + TestConstantsTest.G1_HOME_URL);
        DriverUtilsTest.takeScreenshot(driver, "HomePage_Navigation");
        ...
        Assert.assertEquals(actualTitle, TestConstantsTest.EXPECTED_TITLE, "Title mismatch!");
        Golden1SmokeTest.pass("Title validated successfully");
        DriverUtilsTest.takeScreenshot(driver, "HomePage_TitleValidation");
    ...
    private void validateTab(String tabName) {
        ...
        DriverUtilsTest.takeScreenshot(driver, "TabValidation_" + tabName);
    }
